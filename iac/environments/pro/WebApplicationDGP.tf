module "WebApplicationDGP_app_service_plan" {
  ...
  environment         = "qa"
  service_name        = "uksouth-iflx-WebAppDGP-pro-plan"
  kind                = "app"
...
module "WebApplicationDGP_app_service" {
  ...
  resource_group_name         = "uksouth-iflx-shar-qa-rg"
  environment                 = "qa"
  service_name                = "uksouth-iflx-shar-WebApplicationDGP-pro-app"
  ...
  #alert_action_group_id       = azurerm_monitor_action_group.module_azurerm_monitor_action_group.id
  app_settings = {
          ANCM_ADDITIONAL_ERROR_PAGE_LINK                 = "https://uksouth-iflx-shar-WebApplicationDGP-qa-app.scm.azurewebsites.net/detectors?type=tools&name=eventviewer"
